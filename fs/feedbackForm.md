...
Работа функции mail зависит от настроек сервера. Она может работать по-разному на openserver (читайте документацию (https://ospanel.io/docs/#smtp)[https://ospanel.io/docs/#smtp]) и на хостинге (можно узнать у хостера спросив: "как настроить отправку почты по php mail?").
