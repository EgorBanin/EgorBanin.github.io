...
note left
    Те, кто участвует в обмене.
    Например Петя и Миша.
end note
...
@ пример из ТЗ с промежуточными таблицами
...
Пока такое не увидишь, не поймёшь почему API отвечает так небыстро :-) Кроме этого тут сразу видно что можно сделать лучше. Во-первых выкинуть парочку запросов в Атлант. Во-вторых переключать автопродление у конкретной подписки, а не у абы какой.
